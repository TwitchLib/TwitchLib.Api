...
namespace TwitchLib.Api.Helix
{
    public class Predictions : ApiBase
    {
        ...
        public Task<EndPredictionResponse> EndPredictionAsync(string broadcasterId, string id, PredictionStatus status, string winningOutcomeId = null, string accessToken = null)
        {
