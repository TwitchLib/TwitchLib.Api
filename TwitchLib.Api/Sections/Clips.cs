...
namespace TwitchLib.Api.Sections
{
    public class Clips
    {
        ...
        public class V5Api : ApiSection
        {
            ...
            public Task<Models.v5.Clips.TopClipsResponse> GetTopClipsAsync(string channel = null, string cursor = null,
                string game = null, long limit = 10, Models.v5.Clips.Period period = Models.v5.Clips.Period.Week,
                bool trending = false)
            {
                var getParams =
                ...
                return Api.TwitchGetGenericAsync<Models.v5.Clips.TopClipsResponse>("/clips/top", ApiVersion.v5,
                    getParams);
            }
            ...
            public Task<Models.v5.Clips.FollowClipsResponse> GetFollowedClipsAsync(long limit = 10,
                string cursor = null, bool trending = false, string authToken = null)
            {
                ...
                return Api.TwitchGetGenericAsync<Models.v5.Clips.FollowClipsResponse>("/clips/followed", ApiVersion.v5,
                    getParams, accessToken: authToken);
            }
        ...
        public class HelixApi : ApiSection
        {
            ...
            public Task<Models.Helix.Clips.GetClip.GetClipResponse> GetClipAsync(string clipId = null,
                string gameId = null, string broadcasterId = null, string before = null, string after = null,
                int first = 20)
            {
                ...
                if (getParams.Count != 1)
                    throw new BadParameterException(
                        "One of the following parameters must be set: clipId, gameId, broadcasterId. Only one is allowed to be set.");
                ...
                return Api.TwitchGetGenericAsync<Models.Helix.Clips.GetClip.GetClipResponse>("/clips", ApiVersion.Helix,
                    getParams);
            }
            ...
            public Task<Models.Helix.Clips.CreateClip.CreatedClipResponse> CreateClipAsync(string broadcasterId,
                string authToken = null)
            {
                ...
                return Api.TwitchPostGenericAsync<Models.Helix.Clips.CreateClip.CreatedClipResponse>("/clips",
                    ApiVersion.Helix, null, getParams, accessToken: authToken);
            }
